define({ "api": [
  {
    ...
    "title": "search",
    "group": "Attendance",
    "description": "<p>this api searches employee employee attendance and the descriptive data</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "\n{\n   \"abstractData\": {\n       \"totalAbsentDays\": 7,\n       \"totalLateDays\": 1,\n       \"totalLateHours\": 1,\n       \"totalEarlyDays\": 2,\n       \"overtimeHours\": 2\n   },\n   \"data\": [\n       {\n           \"attendanceDate\": \"1/1/2019\",\n           \"inTime\": \"09:00:00\",\n           \"outTime\": \"16:00:00\",\n           \"clockIn\": \"00:00:00\",\n           \"clockOut\": \"00:00:00\",\n           \"late\": 0,\n           \"early\": 0,\n           \"absent\": \"T\",\n           \"employeeId\": 0,\n           \"department\": \"Krennova\",\n           \"employeeNumber\": 24,\n           \"fullName\": \"Amogh Ganesh Shakya\"\n       },....\n          maybe 29-30 more\n      ]",
          "type": "json"
        }
      ]
    },
    ...
    "name": "GetEmployeesEmployeeidYearMonth"
  },
  {
    "type": "get",
    "url": "/employees/IdAndName",
  ...
  },
  {
    ...
    "group": "E__Satyam_kep_api_docs_doc_main_js",
    "groupTitle": "E__Satyam_kep_api_docs_doc_main_js",
    "name": ""
  },
  {
    "type": "post",
  ...
  {
    "type": "delete",
    "url": "/LeaveRequests/:leaveId",
    "title": "delete Leave request",
    "group": "Leave",
    "description": "<p>this api gets data to populate in employee Panel</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
          "content": "     {\n               success:'true',\n            message:'Deleted Pending Leave Request'\n}",
          "type": "json"
        }
      ]
    },
    ...
    "version": "0.0.0",
    "filename": "./leaveDoc.js",
    "groupTitle": "Leave",
    "name": "DeleteLeaverequestsLeaveid"
  },
  {
    "type": "get",
    "url": "/LeaveRequests/:employeeId/:year/:month",
    "title": "Get Leave Request in a month by ID",
    "group": "Leave",
    "description": "<p>this api gets data to populate in employee Panel</p>",
    "success": {
      "examples": [
    ...
    "filename": "./leaveDoc.js",
    "groupTitle": "Leave",
    "name": "GetLeaverequestsEmployeeidYearMonth"
  },
  {
    "type": "get",
    "url": "/LeaveRequests/:year/:month",
    ...
    "filename": "./leaveDoc.js",
    "groupTitle": "Leave",
    "name": "GetLeaverequestsYearMonth"
  },
  {
    "type": "post",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "reason",
            "description": "<p>reason of leave short description</p>"
          },
          {
            "group": "Parameter",
            "optional": false,
            "field": "amount",
            "description": "<p>amount of leave</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "employeeId",
            "description": "<p>employeeId of the employee</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "put",
    "url": "/resumeLeave/:employeeId/:leaveId",
    "title": "resume leave",
    "group": "Leave",
    "description": "<p>This api resumes the employees leave and sets end date to today</p>",
    "success": {
      "examples": [
        {
          "title": "Success-Response:",
    ...
    "filename": "./leaveDoc.js",
    "groupTitle": "Leave",
    "name": "PutResumeleaveEmployeeidLeaveid"
  },
  {
    "type": "post",
    "url": "/login",
